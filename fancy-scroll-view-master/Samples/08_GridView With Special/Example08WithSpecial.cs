...
{
    class Example08WithSpecial : MonoBehaviour
    {
        [SerializeField]
        GridView gridView = default;

        [SerializeField]
        InputField paddingTopInputField = default;

        [SerializeField]
        InputField paddingBottomInputField = default;

        [SerializeField]
        InputField xSpacingInputField = default;

        [SerializeField]
        InputField ySpacingInputField = default;

        [SerializeField]
        InputField dataCountInputField = default;

        [SerializeField]
        InputField selectIndexInputField = default;

        [SerializeField]
        Dropdown alignmentDropdown = default;

        public Button resetSpecialCellBtn;
        ...
        void Start()
        {
            ...
            dataCountInputField.text = "20000";

            resetSpecialCellBtn.onClick.AddListener(gridView.ResetSpecialCells);
