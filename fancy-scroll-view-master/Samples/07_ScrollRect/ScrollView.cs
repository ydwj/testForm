...
namespace FancyScrollView.Example07
{
    class ScrollView : FancyScrollRect<ItemData, Context>
    {
        ...
        protected override void Initialize()
        {
            ...
            Scroller.onScrollerGetPointerDownPosition.AddListener(ScrollToScrollbarPointerDown);

            Scroller.OnAutoScrollStart(() => { Debug.Log("Auto Scroll Start"); });
            Scroller.OnAutoScrollEnd(() => { Debug.Log("Auto Scroll End"); });
        }
        ...
        /// <summary>
        /// ScrollTo Scrollbar点击的位置
        /// </summary>
        /// <param name="position"></param>
        private void ScrollToScrollbarPointerDown(float position)
        {
            var index = (int)position;
            UpdateSelection(index);
            ScrollTo(index,0.125f);
        }
