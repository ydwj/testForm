...
namespace FancyScrollView
{
    public abstract class
        FancyGridViewWithSpecial<TItemData, TContext> : FancyScrollRectWithSpecial<TItemData[], TContext>
        where TContext : class, IFancyGridViewContext, new()
    {
        /// <summary>
        /// デフォルトのセルグループクラス.
        /// </summary>
        protected abstract class DefaultCellGroup : FancyCellGroupWithSpecial<TItemData, TContext> { }
        ...
        protected virtual void Setup<TGroup>(FancyCellWithSpecial<TItemData, TContext> cellTemplate)
            where TGroup : FancyCellWithSpecial<TItemData[], TContext>
        {
    ...
    public abstract class FancyGridViewWithSpecial<TItemData> : 
        FancyGridViewWithSpecial<TItemData, FancyGridViewContext> { }
}