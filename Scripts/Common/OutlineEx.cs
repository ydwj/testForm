...
namespace TooSimpleFramework.UI
{
    ...
    public class OutlineEx : BaseMeshEffect
    {
        ...
        static readonly string STR_OUTLINESHADER = "TSF Shaders/UI/OutlineEx";
        ...
        protected override void Start()
        {
            ...
            if (shader == default)
            {
                shader = Shader.Find(STR_OUTLINESHADER);
            }
        ...
        protected override void OnDestroy()
        {
            ...
            {
                var shader = Shader.Find("TSF Shaders/UI/OutlineEx");
                if (base.graphic.material.shader == shader)
                {
        ...
        private void _Refresh()
        {
            ...
            //propertyBlock.SetColor("_OutlineColor", this.OutlineColor);
            //propertyBlock.SetInt("_OutlineWidth", this.OutlineWidth);
            //base.graphic.canvasRenderer.SetPropertyBlock(propertyBlock);
